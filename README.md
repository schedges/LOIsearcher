...
## Summary
Quick python script to search LOIs for user-specified words, returns LOIs with most occurrences of that word/phrase. Tested with python 3.7.4 and OS X 10.15.6, not tested with other set-ups. Can be used to find relevant LOIs, citations, authors, etc. Probably will not work well if searching for special characters. The LOIs were downloaded from: [https://www.snowmass21.org/docs/files/?dir=summaries] on 10/7/2020.
